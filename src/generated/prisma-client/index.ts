...
export interface Prisma {
  ...
  law: (where: LawWhereUniqueInput) => LawPromise;
  laws: (
    args?: {
      where?: LawWhereInput;
  ...
  createLaw: (data: LawCreateInput) => LawPromise;
  updateLaw: (
    args: { data: LawUpdateInput; where: LawWhereUniqueInput }
  ) => LawPromise;
  updateManyLaws: (
    args: { data: LawUpdateManyMutationInput; where?: LawWhereInput }
  ) => BatchPayloadPromise;
  upsertLaw: (
    args: {
  ...
  deleteLaw: (where: LawWhereUniqueInput) => LawPromise;
  deleteManyLaws: (where?: LawWhereInput) => BatchPayloadPromise;
...
export interface LawUpdateManyMutationInput {
  altTitle?: String;
  altSlug?: String;
  historic?: Boolean;
  indexedAt?: DateTimeInput;
...
export interface LawPreviousValuesPromise
  extends Promise<LawPreviousValues>,
    Fragmentable {
...
export interface LawPreviousValuesSubscription
  extends Promise<AsyncIterator<LawPreviousValues>>,
    Fragmentable {
...
export interface AggregateLaw {
  count: Int;
}

export interface AggregateLawPromise
  extends Promise<AggregateLaw>,
    Fragmentable {
  count: () => Promise<Int>;
}

export interface AggregateLawSubscription
  extends Promise<AsyncIterator<AggregateLaw>>,
    Fragmentable {
...
export interface LawSubscriptionPayloadPromise
  extends Promise<LawSubscriptionPayload>,
    Fragmentable {
...
export interface LawSubscriptionPayloadSubscription
  extends Promise<AsyncIterator<LawSubscriptionPayload>>,
    Fragmentable {
...
export interface LawConnectionPromise
  extends Promise<LawConnection>,
    Fragmentable {
  pageInfo: <T = PageInfo>() => T;
  edges: <T = FragmentableArray<LawEdge>>() => T;
  aggregate: <T = AggregateLaw>() => T;
}

export interface LawConnectionSubscription
  extends Promise<AsyncIterator<LawConnection>>,
    Fragmentable {
...
export interface LawEdgePromise extends Promise<LawEdge>, Fragmentable {
  node: <T = Law>() => T;
  cursor: () => Promise<String>;
}

export interface LawEdgeSubscription
  extends Promise<AsyncIterator<LawEdge>>,
    Fragmentable {
  node: <T = LawSubscription>() => T;
...
export interface LawPromise extends Promise<Law>, Fragmentable {
  altTitle: () => Promise<String>;
  altSlug: () => Promise<String>;
  createdAt: () => Promise<DateTimeOutput>;
  historic: () => Promise<Boolean>;
  ...
  justiceSystem: () => Promise<JusticeSystemEnum>;
  language: () => Promise<LanguageEnum>;
  lawBasedOnLaw: <T = FragmentableArray<Law>>(
    args?: {
      where?: LawWhereInput;
      orderBy?: LawOrderByInput;
      skip?: Int;
  ...
  lawIsBaseForLaw: <T = FragmentableArray<Law>>(
    args?: {
      where?: LawWhereInput;
      orderBy?: LawOrderByInput;
      skip?: Int;
...
export interface LawSubscription
  extends Promise<AsyncIterator<Law>>,
    Fragmentable {
  altTitle: () => Promise<AsyncIterator<String>>;
  altSlug: () => Promise<AsyncIterator<String>>;
  createdAt: () => Promise<AsyncIterator<DateTimeOutput>>;
